...
pub fn get_termin(r: &Referent) -> Option<String> {
    get_str(r, ATTR_TERMIN)
}
pub fn get_termin_add(r: &Referent) -> Option<String> {
    get_str(r, ATTR_TERMIN_ADD)
}
pub fn get_value(r: &Referent) -> Option<String> {
    get_str(r, ATTR_VALUE)
}
pub fn get_kind_str(r: &Referent) -> Option<String> {
    get_str(r, ATTR_KIND)
}
