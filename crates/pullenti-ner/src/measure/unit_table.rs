...
static BASES: &[BaseUnit] = &[
    ...
    BaseUnit {
        ...
        si_abbr_cyr: "М.",
        si_abbr_lat: "M.",
        si_base_names_ru: &["МЕТР", "МЕТРОВЫЙ"],
        si_base_names_en: &["METER", "METRE"],
    },
    BaseUnit {
    ...
    BaseUnit {
        ...
        si_abbr_cyr: "Г.;ГР.",
        si_abbr_lat: "G.;GR.",
        si_base_names_ru: &["ГРАММ", "ГРАММНЫЙ"],
        si_base_names_en: &["GRAM", "GRAMME"],
    },
    BaseUnit {
    ...
    BaseUnit {
        ...
        si_abbr_cyr: "Т.",
        si_abbr_lat: "T.",
        si_base_names_ru: &["ТОННА", "ТОННЫЙ"],
        si_base_names_en: &["TONNE", "TON"],
    },
    // ── Volume ───────────────────────────────────────────────────────────────
    BaseUnit {
        names: &[
        ...
        si_abbr_cyr: "Л.",
        si_abbr_lat: "L.",
        si_base_names_ru: &["ЛИТР", "ЛИТРОВЫЙ"],
        si_base_names_en: &["LITER", "LITRE"],
    },
    BaseUnit {
        names: &[
            "КУБ.М.",
    ...
    BaseUnit {
        ...
        si_abbr_cyr: "С.;СЕК.",
        si_abbr_lat: "S.;SEC.",
        si_base_names_ru: &["СЕКУНДА", "СЕКУНДНЫЙ"],
        si_base_names_en: &["SECOND"],
    },
    BaseUnit {
        names: &[
            "МИНУТА",
    ...
    BaseUnit {
        ...
        kind: MeasureKind::Voltage,
        canonical: "В",
        fullname: "вольт",
        si_prefixes: &[KILO, MEGA, MILLI, MICRO],
        si_abbr_cyr: "В.",
        si_abbr_lat: "V.",
        si_base_names_ru: &["ВОЛЬТ", "ВОЛЬТНЫЙ"],
        si_base_names_en: &["VOLT"],
    },
    // ── Power ────────────────────────────────────────────────────────────────
    BaseUnit {
        ...
        si_abbr_cyr: "ВТ.",
        si_abbr_lat: "W.",
        si_base_names_ru: &["ВАТТ", "ВАТТНЫЙ"],
        si_base_names_en: &["WATT", "WATTS"],
    },
    BaseUnit {
        names: &["ЛОШАДИНАЯ СИЛА", "Л.С.", "ЛС", "HP", "PS", "HORSEPOWER"],
        kind: MeasureKind::Power,
        canonical: "л.с.",
        fullname: "лошадиная сила",
        si_prefixes: &[],
        si_abbr_cyr: "",
        si_abbr_lat: "",
        si_base_names_ru: &[],
    ...
    BaseUnit {
        ...
        si_abbr_cyr: "ДЖ.",
        si_abbr_lat: "J.",
        si_base_names_ru: &["ДЖОУЛЬ"],
        si_base_names_en: &["JOULE"],
    },
    BaseUnit {
        names: &[
            "КАЛОРИЯ",
    ...
    BaseUnit {
        ...
        si_abbr_lat: "Ω",
        si_base_names_ru: &["ОМ"],
        si_base_names_en: &["OHM"],
    },
    // ── Current ──────────────────────────────────────────────────────────────
    BaseUnit {
        names: &["АМПЕР", "АМПЕРА", "АМПЕР", "А", "A", "AMP", "AMPERE"],
        kind: MeasureKind::Current,
        canonical: "А",
        fullname: "ампер",
        si_prefixes: &[KILO, MEGA, GIGA, MICRO, MILLI],
        si_abbr_cyr: "А.",
        si_abbr_lat: "A.",
        si_base_names_ru: &["АМПЕР", "АМПЕРНЫЙ"],
        si_base_names_en: &["AMPERE", "AMP"],
    },
    // ── Frequency ─────────────────────────────────────────────────────────────
    BaseUnit {
        ...
        si_abbr_cyr: "ГЦ.",
        si_abbr_lat: "HZ.",
        si_base_names_ru: &["ГЕРЦ", "ГЕРЦОВЫЙ"],
        si_base_names_en: &["HERZ", "HERTZ"],
    },
    // ── Pressure ─────────────────────────────────────────────────────────────
    BaseUnit {
        ...
        si_abbr_cyr: "ПА.",
        si_abbr_lat: "PA.",
        si_base_names_ru: &["ПАСКАЛЬ"],
        si_base_names_en: &["PASCAL"],
    },
    BaseUnit {
        names: &["БАР", "BAR", "BARS"],
        kind: MeasureKind::Pressure,
    ...
    BaseUnit {
        ...
        kind: MeasureKind::Pressure,
        canonical: "мм.рт.ст.",
        fullname: "миллиметр ртутного столба",
        si_prefixes: &[],
        si_abbr_cyr: "",
        si_abbr_lat: "",
        si_base_names_ru: &[],
    ...
    BaseUnit {
        ...
        si_abbr_cyr: "БИТ",
        si_abbr_lat: "BIT",
        si_base_names_ru: &["БИТ"],
        si_base_names_en: &["BIT"],
    },
    BaseUnit {
        ...
        si_abbr_cyr: "Б.",
        si_abbr_lat: "B.",
        si_base_names_ru: &["БАЙТ"],
        si_base_names_en: &["BYTE"],
    },
    // ── Angle ─────────────────────────────────────────────────────────────────
    BaseUnit {
    ...
    BaseUnit {
        ...
        si_abbr_cyr: "Н.",
        si_abbr_lat: "N.",
        si_base_names_ru: &["НЬЮТОН"],
        si_base_names_en: &["NEWTON"],
    },
    // ── Luminous ──────────────────────────────────────────────────────────────
    BaseUnit {
        names: &["ЛЮКС", "ЛК", "LX", "LUX"],
        kind: MeasureKind::Luminous,
        canonical: "лк",
        fullname: "люкс",
        si_prefixes: &[],
        si_abbr_cyr: "",
    ...
    BaseUnit {
        ...
        kind: MeasureKind::Capacity,
        canonical: "Ф",
        fullname: "фарад",
        si_prefixes: &[KILO, MICRO, MILLI, NANO, PICO],
        si_abbr_cyr: "Ф.",
        si_abbr_lat: "F.",
        si_base_names_ru: &["ФАРАД"],
        si_base_names_en: &["FARAD"],
    },
    // ── Radiation ─────────────────────────────────────────────────────────────
    BaseUnit {
        names: &["ЗИВЕРТ", "ЗВ", "SV", "SIEVERT"],
        kind: MeasureKind::Radiation,
        canonical: "Зв",
        fullname: "зиверт",
        si_prefixes: &[KILO, MEGA, GIGA, MICRO, MILLI, NANO],
        si_abbr_cyr: "ЗВ.",
        si_abbr_lat: "SV.",
        si_base_names_ru: &["ЗИВЕРТ"],
        si_base_names_en: &["SIEVERT"],
    },
    BaseUnit {
        ...
        si_abbr_cyr: "БК.",
        si_abbr_lat: "BQ.",
        si_base_names_ru: &["БЕККЕРЕЛЬ"],
        si_base_names_en: &["BECQUEREL"],
    },
];
...
fn build_table() -> HashMap<String, UnitInfo> {
    ...
    for base in BASES {
        ...
        for &si_idx in base.si_prefixes {
            ...
            let pref_canonical = if base.si_abbr_cyr.is_empty() {
                ...
                format!(
                    "{}{}",
                    p.abbr_cyr.to_lowercase(),
                    base_abbr.trim_end_matches('.').to_lowercase()
                )
            };
            ...
            let pref_info = UnitInfo {
                kind: base.kind,
                canonical: leaked_canonical,
    ...
    for &(name, kind, canonical, fullname) in extras {
        map.entry(name.to_string()).or_insert(UnitInfo {
            kind,
            canonical,
            fullname,
        });
