...
impl ExplanWordAttr {
    ...
    pub fn set_animated(&mut self, v: bool) {
        self.set_bit(0, v);
    }
    ...
    pub fn is_emo_positive(self) -> bool {
        self.get_bit(4)
    }
    pub fn is_emo_negative(self) -> bool {
        self.get_bit(5)
    }
    ...
    pub fn is_can_person_after(self) -> bool {
        self.get_bit(8)
    }
    pub fn is_space_object(self) -> bool {
        self.get_bit(9)
    }
    pub fn is_time_object(self) -> bool {
        self.get_bit(10)
    }
    pub fn is_verb_noun(self) -> bool {
        self.get_bit(11)
    }
}
