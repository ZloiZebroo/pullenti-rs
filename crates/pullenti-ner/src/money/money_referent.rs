...
pub fn get_currency(r: &Referent) -> Option<String> {
    get_str(r, ATTR_CURRENCY)
}
...
pub fn set_currency(r: &mut Referent, v: &str) {
    set_str(r, ATTR_CURRENCY, v);
}
pub fn set_value(r: &mut Referent, v: &str) {
    set_str(r, ATTR_VALUE, v);
}
pub fn set_rest(r: &mut Referent, v: i32) {
    if v != 0 {
        set_str(r, ATTR_REST, &v.to_string());
    }
}
