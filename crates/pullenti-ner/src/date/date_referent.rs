...
fn set_int(r: &mut Referent, attr: &str, v: i32) {
    ...
    if v != 0 {
        r.slots
            .push(Slot::new(attr, Some(SlotValue::Str(v.to_string()))));
    }
}

pub fn get_year(r: &Referent) -> i32 {
    get_int(r, ATTR_YEAR, 0)
}
pub fn get_month(r: &Referent) -> i32 {
    get_int(r, ATTR_MONTH, 0)
}
pub fn get_day(r: &Referent) -> i32 {
    get_int(r, ATTR_DAY, 0)
}
pub fn get_hour(r: &Referent) -> i32 {
    get_int(r, ATTR_HOUR, -1)
}
pub fn get_minute(r: &Referent) -> i32 {
    get_int(r, ATTR_MINUTE, -1)
}
pub fn get_second(r: &Referent) -> i32 {
    get_int(r, ATTR_SECOND, -1)
}
pub fn get_century(r: &Referent) -> i32 {
    get_int(r, ATTR_CENTURY, 0)
}
pub fn get_quartal(r: &Referent) -> i32 {
    get_int(r, ATTR_QUARTAL, 0)
}
pub fn get_halfyear(r: &Referent) -> i32 {
    get_int(r, ATTR_HALFYEAR, 0)
}

pub fn set_year(r: &mut Referent, v: i32) {
    set_int(r, ATTR_YEAR, v)
}
pub fn set_month(r: &mut Referent, v: i32) {
    set_int(r, ATTR_MONTH, v)
}
pub fn set_day(r: &mut Referent, v: i32) {
    set_int(r, ATTR_DAY, v)
}
pub fn set_hour(r: &mut Referent, v: i32) {
    r.slots.retain(|s| s.type_name != ATTR_HOUR);
    r.slots
        .push(Slot::new(ATTR_HOUR, Some(SlotValue::Str(v.to_string()))));
}
pub fn set_minute(r: &mut Referent, v: i32) {
    r.slots.retain(|s| s.type_name != ATTR_MINUTE);
    r.slots
        .push(Slot::new(ATTR_MINUTE, Some(SlotValue::Str(v.to_string()))));
}
pub fn set_second(r: &mut Referent, v: i32) {
    r.slots.retain(|s| s.type_name != ATTR_SECOND);
    r.slots
        .push(Slot::new(ATTR_SECOND, Some(SlotValue::Str(v.to_string()))));
}
pub fn set_century(r: &mut Referent, v: i32) {
    set_int(r, ATTR_CENTURY, v)
}
pub fn set_quartal(r: &mut Referent, v: i32) {
    set_int(r, ATTR_QUARTAL, v)
}
pub fn set_halfyear(r: &mut Referent, v: i32) {
    set_int(r, ATTR_HALFYEAR, v)
}
...
pub fn set_pointer(r: &mut Referent, p: DatePointerType) {
    if p != DatePointerType::No {
        ...
        r.slots
            .push(Slot::new(ATTR_POINTER, Some(SlotValue::Str(p.to_string()))));
    }
}
...
pub fn set_higher_ref(r: &mut Referent, higher: std::rc::Rc<std::cell::RefCell<Referent>>) {
    ...
    r.slots
        .push(Slot::new(ATTR_HIGHER, Some(SlotValue::Referent(higher))));
}
