...
fn get_tables() -> &'static Tables {
    TABLES.get_or_init(|| {
        ...
        types.insert(
            "МИКРОАВТОБУС".to_string(),
            TypeEntry {
                canonical: "микроавтобус",
                kind: TransportKind::Auto,
            },
        );
        types.insert(
        ...
        types.insert(
            "ВНЕДОРОЖНИК".to_string(),
            TypeEntry {
                canonical: "внедорожник",
                kind: TransportKind::Auto,
            },
        );
        ...
        types.insert(
            "ТРАНСПОРТНОЕ СРЕДСТВО".to_string(),
            TypeEntry {
                canonical: "автомобиль",
                kind: TransportKind::Auto,
            },
        ...
        for (key, canon) in car_brands {
            brands.entry(key.to_string()).or_insert(BrandEntry {
                canonical: canon,
                kind: TransportKind::Auto,
            });
        }
